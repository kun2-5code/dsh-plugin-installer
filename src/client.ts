...
const NAMESPACE = 'dsh-plugin-installer'
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('span', { className: 'dtpl-name' }, 'dsh-plugin-installer'),
